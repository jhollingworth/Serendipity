...
<%@ Import Namespace="Serendipity.Web.Controllers" %>
    ...
    <p>
        ...
        <ol>
            <li>
                ...
                within Serendipity.Web/NHibernate.config</span>
	        </li>
            <li>
                Optionally, modify the Fluent NHibernate preferences within Serendipity.Data.NHibernateMaps.GetConventions() 
            ...
            <li>
                Open Serendipity.Tests.dll via NUnit and make sure all the tests are turning green.
	        </li>
            <li>
                ...
                Serendipity.Web.Controllers.RouteRegistrar.RegisterRoutesTo() after the scaffolding generator has completed.)
	        </li>
        </ol>
    </p>
    <p>
