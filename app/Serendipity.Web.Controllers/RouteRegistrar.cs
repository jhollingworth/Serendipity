...
namespace Serendipity.Web.Controllers
{
    public class RouteRegistrar
    {
        public static void RegisterRoutesTo(RouteCollection routes)
        {
            ...
            //routes.CreateArea("Organization/Department", "Serendipity.Web.Controllers.Organization.Department",
            ...
            //);
            //routes.CreateArea("Organization", "Serendipity.Web.Controllers.Organization",
            ...
            routes.CreateArea("Root", "Serendipity.Web.Controllers",
